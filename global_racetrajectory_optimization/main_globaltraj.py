...
file_paths = {"veh_params_file": "f1_racecar.ini"}
...
file_paths["track_name"] = "f1_wide_log"                                    # Berlin Formula E 2018
...
lap_time_mat_opts = {"use_lap_time_mat": False,             # calculate a lap time matrix (diff. top speeds and scales)
                     ...
                     "top_speed_range": [1.0, 7.0],     # range of top speeds to be simulated [in km/h]
