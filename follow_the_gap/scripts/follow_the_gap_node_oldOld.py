...
for i in range(NR_SCANS):
    weighting_vec[i] = 6 - np.abs(i-mid_ray_int)/mid_ray_int*5
...
GAP_TH = 2.2
RED_GAP = 8 #Rays
Gap_Clearance = 0.2 # 30 cm --> Disperity
...
class GapFollow:
    ...
    def get_gaps(self,thres,ranges):
    ...
    def calcVelocity(self):
        ...
        v = 2+self.midRayRange*0.8+self.gap_mean*0.05 #- abs_deg_angle*0.005
        self.velocity = v*0.3
